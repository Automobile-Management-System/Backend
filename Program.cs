...
// using automobile_backend.Services;
// using automobile_backend.Services.Interfaces;
// using automobile_backend.WebSockets; // ✅ ADD THIS
// using Microsoft.AspNetCore.Authentication.JwtBearer;
// using Microsoft.EntityFrameworkCore;
// using Microsoft.IdentityModel.Tokens;
// using Microsoft.OpenApi.Models;
...
// // Enable HttpContext Accessor
// builder.Services.AddHttpContextAccessor();

// // Add Memory Cache
// builder.Services.AddMemoryCache();

// // ✅ Register your repositories and services (unchanged)
// builder.Services.AddScoped<IAuthRepository, AuthRepository>();
// builder.Services.AddScoped<IAuthService, AuthService>();
// builder.Services.AddScoped<ICustomerDashboardRepository, CustomerDashboardRepository>();
// builder.Services.AddScoped<ICustomerDashboardService, CustomerDashboardService>();
...
// // ✅ Add SignalR (keep for other features)
// builder.Services.AddSignalR();
...
// //app.UseHttpsRedirection(); // optional for local testing
// app.UseCors(MyAllowSpecificOrigins);
...
// app.Map("/ws/admin-notifications", async (HttpContext context) =>
// {
//     if (context.WebSockets.IsWebSocketRequest)
//     {
//         using var webSocket = await context.WebSockets.AcceptWebSocketAsync();
//         var adminId = context.Request.Query["adminId"].ToString() ?? Guid.NewGuid().ToString();

//         WebSocketHandler.AddSocket(adminId, webSocket);
...
//         await WebSocketHandler.RemoveSocket(adminId);
...
using automobile_backend.Services;
using automobile_backend.Services.Interfaces;
using automobile_backend.WebSockets; // ✅ custom WebSocket handler
using Microsoft.AspNetCore.Authentication.JwtBearer;
using Microsoft.EntityFrameworkCore;
using Microsoft.IdentityModel.Tokens;
using Microsoft.OpenApi.Models;
...
const string MyAllowSpecificOrigins = "AllowFrontend";
const string ExternalCookieAuthenticationScheme = "ExternalCookie";
...
// 🚫 Removed: builder.Services.AddSignalR();
